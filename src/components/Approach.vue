<template>
  <section id="approach" class="relative bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 text-white py-16 font-vt323 overflow-hidden">
      ...
      <div class="mb-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-6">
          <div
            ...
            :key="approach.id"
            class="bg-gray-800 border-2 border-limegreen shadow-lg rounded p-6 hover:shadow-xl hover:border-cyan-400 transition-all duration-300"
          >
      ...
      <div class="mb-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 max-w-6xl mx-auto">
          <div v-for="benefit in benefits" :key="benefit.title" class="flex flex-col items-center text-center">
            <div class="w-20 h-20 flex items-center justify-center rounded-full bg-gray-800 border-2 border-limegreen shadow-lg mb-4">
              <component 
                :is="benefit.icon" 
                :size="40" 
                :stroke-width="2"
...
import { Target, Palette, Zap, BarChart3, Rocket, TrendingUp, DollarSign, Users, Shield, Settings } from 'lucide-vue-next'
...
const approaches = [
  {
    ...
    phase: 'Steg 1',
    icon: Target,
    description: 'Vi sätter mål, målgrupp och en enkel plan. Rätt saker i rätt ordning – utan krångel.',
    deliverables: [
      'Mål och målgrupp',
      'Enkel projektplan',
  ...
  },
  {
    ...
    phase: 'Steg 2',
    icon: Palette,
    description: 'Tydlig, modern design som gör det lätt att förstå och lätt att kontakta.',
    deliverables: [
      'Skisser & förslag',
  ...
  },
  {
    ...
    phase: 'Steg 3',
    icon: Zap,
    description: 'Jag bygger snabbt och stabilt. Du kan prova under tiden och ge feedback.',
    deliverables: [
      'Färdig hemsida',
  ...
  },
  {
    ...
    phase: 'Steg 4',
    icon: BarChart3,
    description: 'Gör sidan lätt att hitta och snabb att använda – för både kunder och Google/AI.',
    deliverables: [
  ...
  },
  {
    ...
    phase: 'Steg 5',
    icon: Rocket,
    description: 'Smidig lansering. Du får en enkel genomgång – jag sköter ändringar åt dig när du vill.',
    deliverables: [
...
const benefits = [
  ...
  },
  {
    ...
    icon: Shield,
    description: 'Modern lösning som håller länge och som du själv kontrollerar.',
    features: [
